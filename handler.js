...
${user.bannedReason}` : '🕵 *Motivo:* Sin Especificar'}\n\n🍭 Si quieres que seas desbaneado en este bot escribe a: Wa.me/5215646809363`)
user.antispam++        
return
}
...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify|ai|ragna|a|s)/gi)) {
